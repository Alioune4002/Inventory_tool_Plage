...
PLAN_REGISTRY: Dict[str, Dict[str, Any]] = {
    "ESSENTIEL": {
        ...
        "limits": {
            ...
            "labels_pdf_monthly_limit": 2,
            "receipts_import_monthly_limit": 2,
    ...
    "BOUTIQUE": {
        ...
        "limits": {
            ...
            "labels_pdf_monthly_limit": 20,
            "receipts_import_monthly_limit": 30,
    ...
    "PRO": {
        ...
        "limits": {
            ...
            "labels_pdf_monthly_limit": None,
            "receipts_import_monthly_limit": None,
