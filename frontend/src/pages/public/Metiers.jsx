// frontend/src/pages/public/Metiers.jsx
...
export default function Metiers() {
  return (
    <PublicShell>
      {/* ✅ on ne change rien au style, on arrondit juste le “bloc central” */}
      <main className="mx-auto w-full max-w-6xl px-4 py-12 text-white space-y-8">
        <div className="rounded-[32px] border border-white/10 bg-white/5 p-6 sm:p-8 md:p-10">
