...
export default function PublicShell({ children }) {
  ...
  return (
    <div className="public-shell relative w-full min-h-screen">
     
      <div className="pointer-events-none absolute inset-0 overflow-x-clip">
        <div className="absolute inset-0 opacity-20 bg-grid" />
        <div className="absolute -top-20 -left-24 h-72 w-72 rounded-full bg-blue-600 blur-[140px] opacity-30" />
        <div className="absolute -bottom-24 right-0 h-80 w-80 rounded-full bg-cyan-400 blur-[160px] opacity-20" />
      </div>
